...
- **Таргет на домены** - генерация регулярного выражения для списка доменов
- **Таргет по ключевым словам** - генерация паттерна для поиска ключевых слов в URL
- **Маски доменов** - генерация масок для включения/исключения доменов
